...
-  Skills guide Claude on how to perform specific tasks, e.g., "how to preprocess LC-MS data?"
...
:::
::: {.column width="50%"}
![](../assets/bad_knowledge_management.png){width=70%}
![](../assets/good_knowledge_management.png){width=70%}
:::
:::
:::
